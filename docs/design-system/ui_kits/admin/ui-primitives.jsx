...
const Icon = {
  ...
  Folder:      (p) => <Ic {...p}><path d="M3 3v18h18"/><path d="M9 9h8"/><path d="M9 15h5"/></Ic>,
  Tag:         (p) => <Ic {...p}><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><circle cx="7" cy="7" r="1.2"/></Ic>,
  ...
  Chart:       (p) => <Ic {...p}><path d="M3 3v18h18"/><path d="M7 14l4-4 4 4 5-5"/></Ic>,
  ...
  UserPlus:    (p) => <Ic {...p}><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><path d="M20 8v6"/><path d="M23 11h-6"/></Ic>,
  Pencil:      (p) => <Ic {...p}><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.12 2.12 0 0 1 3 3L12 15l-4 1 1-4z"/></Ic>,
  Trash:       (p) => <Ic {...p}><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></Ic>,

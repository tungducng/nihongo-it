<template>
  <v-container fluid>
    <h2 class="font-weight-bold mb-1" style="font-size: 1.3rem;">Japanese Vocabulary</h2>
...
export default class VocabularyView extends Vue {
  ...
  clearFilter(filterName: 'keyword' | 'jlptLevel' | 'category' | 'contentType') {
